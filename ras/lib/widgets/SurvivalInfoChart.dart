...
class _SurvivalInfoChartState extends State<SurvivalInfoChart> {
  ...
  List<ChartData> getChartData() {
    final List<ChartData> chartData = [
      ChartData('Germinative potential', (0.9 * getTotalItems())),
      ChartData('Hydric stress', (0.2 * getTotalItems())),
      ChartData('Thermal stress', (0.2 * getTotalItems())),
      ChartData('Bad location', (0.5 * getTotalItems())),
      ChartData('Predation', (0.5 * getTotalItems())),
  ...
  List<LineChartData> getLineChartData() {
    final List<LineChartData> lineChartData = [
      ...
      LineChartData((0.2 * getTotalItems()), 'Hydric stress'),
      LineChartData((0.2 * getTotalItems()), 'Thermal stress'),
      LineChartData((0.5 * getTotalItems()), 'Bad location'),
      LineChartData((0.5 * getTotalItems()), 'Predation'),
      LineChartData((0.2 * getTotalItems()), 'Establishment'),
      LineChartData((0.11 * getTotalItems()), 'Survival'),
    ];
